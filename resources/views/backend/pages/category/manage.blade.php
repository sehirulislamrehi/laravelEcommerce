								...
								<tr>
									...
									<td>
										@if( $category->image == NULL )
											No Image Attached
										@else
											<img src="{{ asset('images/category/' . $category->image) }}" class="img-fluid" width="50px">
										@endif
									</td>
									<td>
										@if ( $category->parent_id == 0 )
											<p class="badge badge-primary">Primary Category</p>
										@else
											{{ $category->parent->name }}
										@endif
									</td>
									<td>
										<a href="{{ route('editCategory',$category->id) }}" class="badge badge-success">Update</a>
										<button type="submit" class="badge badge-danger" data-toggle="modal" data-target="#deleteCategory{{ $category->id }}">Delete</button>
									</td>
