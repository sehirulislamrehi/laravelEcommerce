							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										@else
											<img src="{{ asset('images/banner/' . $banner->image) }}" class="img-fluid" width="100px;">
										@endif
									</td>
									
									<td>
										<a href="{{ route('editBanner', $banner->slug) }}" class="badge badge-success">Update</a>
										<button type="submit" class="badge badge-danger" data-toggle="modal" data-target="#deleteBanner{{ $banner->slug }}">Delete</button>
									</td>
									<!-- Modal -->
									<div class="modal fade" id="deleteBanner{{ $banner->slug }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
									  <div class="modal-dialog" role="document">
									    <div class="modal-content">
									      ...
									      <div class="modal-body" style="display: block;margin: 0 auto;">
									      	<form action="{{ route('deleteBanner',$banner->slug) }}" method="post">
									      		@csrf
