						...
						<table class="table table-striped" id="myTable">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="{{ route('editDistrict',$district->id) }}" class="badge badge-success">Update</a>
										
										<button type="submit" class="badge badge-danger" data-toggle="modal" data-target="#deleteDistrict{{ $district->id }}">Delete</button>
									</td>
