    ...
    <div class="br-sideleft sideleft-scrollbar">
      ...
      <ul class="br-sideleft-menu">
        ...
        <li class="br-menu-item">
          <a href="#" class="br-menu-link with-sub">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Manage Banner</span>
          </a><!-- br-menu-link -->
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{ route('manageBanner') }}" class="sub-link">All Banner</a></li>
            <li class="sub-item"><a href="{{ route('createBanner') }}" class="sub-link">Add New Banner</a></li>
          </ul>
        </li>
        <!-- district end -->
        ...
        <li class="br-menu-item">
          ...
          <ul class="br-menu-sub">
            <li class="sub-item"><a href="{{ route('manageAd') }}" class="sub-link">Manage Advertisement</a></li>
          </ul>
        </li>
        <!-- district end -->
