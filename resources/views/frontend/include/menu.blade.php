						...
						<div class="nav-panel__row">
									...
									<div class="departments__body">
										<div class="departments__links-wrapper">
											...
											<ul class="departments__links">
												...
												<li class="departments__item"><a href="#">{{ $pCategory->name }} <svg class="departments__link-arrow" width="6px" height="9px">
							...
							<div class="nav-panel__nav-links nav-links">
								<ul class="nav-links__list">
									...
									<li class="nav-links__item nav-links__item--with-submenu"><a href=""><span>Shop <svg class="nav-links__arrow" width="9px" height="6px">
													<use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use>
												</svg></span></a>
									</li>


									<li class="nav-links__item nav-links__item--with-submenu"><a href="{{ route('blog') }}"><span>Blog <svg class="nav-links__arrow" width="9px" height="6px">
													<use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use>
												</svg></span></a>
								...
								<div class="indicator indicator--trigger--click">
									<a href="" class="indicator__button">
										<span class="indicator__area">
											...
											<span class="indicator__value count" id="totalItems">
									...
									<div class="indicator__dropdown">
										...
										<div class="dropcart">
											...
											<div class="dropcart__buttons">
												<a class="btn btn-secondary" href="">View Cart</a>
