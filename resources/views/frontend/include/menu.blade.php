						...
						<div class="mobile-header__body">
							...
							<div class="mobile-header__indicators">
								<div class="indicator indicator--mobile-search indicator--mobile d-sm-none">
									<button class="indicator__button"><span class="indicator__area"><svg width="20px" height="20px"><use xlink:href="{{ asset('frontend/images/sprite.svg#search-20') }}"></use></svg></span></button>
								</div>
								...
								<div class="indicator indicator--mobile"><a href="cart.html" class="indicator__button"><span class="indicator__area"><svg width="20px" height="20px"><use xlink:href="{{ asset('frontend/images/sprite.svg#cart-20') }}"></use></svg> <span class="indicator__value">3</span></span></a></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="site-header__topbar topbar">
					<div class="topbar__container container">
						...
						<div class="topbar__row">
							<div class="topbar__item topbar__item--link"><a class="topbar-link" href="{{ route('about') }}">mdsehirulislamrehi@gmail.com | 01858361812</a></div>
					...
					<div class="site-header__search">
						<div class="search">
							<form class="search__form" action="{{ route('search') }}" method="get">
								@csrf
								<input class="search__input" name="search" placeholder="Search over 10,000 products" aria-label="Site search" type="text" autocomplete="on">
							...
							<div class="nav-panel__row">
										...
										<div class="departments__body">
											<div class="departments__links-wrapper">
												...
												<ul class="departments__links">
													...
													<li class="departments__item"><a href="#">{{ $pCategory->name }} <svg class="departments__link-arrow" width="6px" height="9px"><use xlink:href="images/sprite.svg#arrow-rounded-right-6x9"></use></svg></a>
														<div class="departments__megamenu departments__megamenu--xl">
															...
															@endforeach
																@if( $childCategory->parent_id == $pCategory->id )
																		...
																		<div class="col-12">
																			<ul class="megamenu__links megamenu__links--level--0">
																				<li class="megamenu__item megamenu__item--with-submenu">
																					<a>
																						All Brands Of {{ $pCategory->name }} 
																					</a>

																					<ul class="megamenu_li megamenu__links megamenu__links--level--1">
																						@foreach( App\Models\Backend\Category::orderBy('id', 'asc')->where('parent_id', $pCategory->id )->get() as $childCategory )
								...
								<div class="nav-panel__nav-links nav-links">
									<ul class="nav-links__list">
										...
										<li class="nav-links__item"><a href="{{ route('about') }}"><span>About Us</span></a></li>

										<li class="nav-links__item nav-links__item--with-submenu"><a href=""><span>Shop <svg class="nav-links__arrow" width="9px" height="6px"><use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use></svg></span></a>
										</li>


										<li class="nav-links__item nav-links__item--with-submenu"><a href="{{ route('blog') }}"><span>Blog <svg class="nav-links__arrow" width="9px" height="6px"><use xlink:href="images/sprite.svg#arrow-rounded-down-9x6"></use></svg></span></a>

										<li class="nav-links__item"><a href="{{ route('contact') }}"><span>Contact Us</span></a></li>

										@if ( Auth('visitor')->user() )
		                                    <li  class="nav-links__item">
		                                    	<a href="{{ route('account') }}"><span><i class="fa fa-user"></i>My Account</span></a>
		                                    </li>
		                                    
		                                    <li  class="nav-links__item"><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><span><i class="fa fa-sign-out"></i>Logout</span></a></li>
		                                    <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
		                                    @csrf
		                                    </form>

		                                @else
										<li class="nav-links__item"><a href="{{ route('showVisitorLoginForm') }}"><span>Login</span></a></li>
										<li class="nav-links__item"><a href="{{ route('showVisitorRegisterForm') }}"><span>Register</span></a></li>
										@endif
									...
									<div class="indicator indicator--trigger--click">
										<a href="" class="indicator__button">
											<span class="indicator__area">
												...
												<span class="indicator__value" id="totalItems">
										...
										<div class="indicator__dropdown">
											...
											<div class="dropcart" >
												...
												<div class="dropcart__buttons">
													<a class="btn btn-secondary" href="{{ route('cart.show') }}">View Cart</a> 
