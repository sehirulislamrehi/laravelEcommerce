        ...
        success: function(data) {
            $("#adTable").prepend(
                '<tr class="table-row" data-id="' +
                    data.id +
                    '" ><td class="ad-image"><img src="/images/ad/' +
                    data.image +
                    '" width="50px"></td><td class="ad-title">' +
                    data.title +
                    '</td><td class="ad-description">' +
                    data.description +
                    '</td><td><button class="btn btn-primary edit" data-toggle="modal" data-target="#editadvertisement">Edit</button><button class="btn btn-danger delete" data-toggle="modal" data-target="#deleteadvertisement">Delete</button></td></tr>'
            );
    ...
    $.ajax({
        ...
        success: function(data) {
            $(adrow)
                ...
                .text(data.title);
            $(adrow)
                .find("td.ad-description")
                .text(data.description);
            $(adrow)
                .find("td.ad-image img")
                .attr("src", "/images/ad/" + data.image);
